...
metadata {
	...
	definition(name: "My Flair HvacUnit", author: "Yves Racine",  mnmn: "SmartThings", vid: "SmartThings-smartthings-Z-Wave_Thermostat",ocfDeviceType: "x.com.st.mode.airconditioner",namespace: "yracine") {
